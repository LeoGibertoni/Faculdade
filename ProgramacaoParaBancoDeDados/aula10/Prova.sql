...
CREATE TABLE ALUNO (
	ALUNO_ID INT IDENTITY(1, 1) NOT NULL CONSTRAINT PK_ALUNO PRIMARY KEY,
	NOME VARCHAR(255) NOT NULL,
	EMAIL VARCHAR (150) NOT NULL CONSTRAINT UN_ALUNO_EMAIL UNIQUE,
	DATA_NASCIMENTO DATETIME NOT NULL,
);	

CREATE TABLE CURSO (
    CURSO_ID INT IDENTITY(1, 1) NOT NULL CONSTRAINT PK_CURSO PRIMARY KEY,
    NOME VARCHAR(100) NOT NULL CONSTRAINT UN_CURSO_NOME UNIQUE,
